...
module.exports = function(webpackEnv) {
  ...
  return {
    ...
    externals: (() => {
      return isEnvProduction ? cdn.plugin : {}
    })(),
    resolve: {
      // 生产环境配置cdn
            ...
            new HtmlWebpackPlugin(
              Object.assign(
                {},
                {
                  ...
                  cdnConfig: isEnvProduction ? cdn.url : [],
                  chunks: isEnvProduction ? ['main'] : [item]
                },
                isEnvProduction
                  ? {
                      minify: {
